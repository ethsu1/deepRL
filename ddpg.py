...
class DDPG:
	...
	def save(self):
		self.actor.save_weights('./ddpg_actor.pth')
		self.critic.save_weights('./ddpg_critic.pth')

	def load(self):
		self.actor.load_weights('./ddpg_actor.pth')
		self.critic.load_weights('./ddpg_critic.pth')
