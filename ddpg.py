...
class DDPG:
	...
	def save(self):
		self.actor.save_weights('./ddpg_actor_lunar.pth')
		self.critic.save_weights('./ddpg_critic_lunar.pth')

	def load(self):
		self.actor.load_weights('./ddpg_actor_lunar.pth')
		self.critic.load_weights('./ddpg_critic_lunar.pth')
